export default function Bottom() {
    return (
        <div className="w-full my-12 px-2 sm:px-32">
            <div className="w-full border-t-2 border-b-2 border-gray-300 flex flex-row flex-wrap justify-between py-12">
                ...
                <div className="min-w-60 w-1/4 flex flex-col gap-4">

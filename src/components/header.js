...
export default function Header() {
    return (
        <div className="relative w-full flex flex-col">
            <div className="px-32 text-white font-bold py-8 flex flex-row justify-between bg-[#514ACD]">
            ...
            <div className="absolute mt-32 w-full px-32">
                <div className="w-full h-40 flex flex-row justify-between">
                    <div className="rounded-xl w-3/4 bg-white p-2 flex flex-col">
                        <div className="flex flex-row bg-[#ecf1fe] w-full p-4 items-center">
                            <div className="w-1/5">Component</div>
                            <div className="w-2/5">Product</div>
                            <div className="w-2/5">Form</div>
                        </div>
                        <div className="flex flex-row p-4">
                            ...
                            <Link className="w-2/5" to="/cpu"><span className=' text-gray-800'>+Choose CPU</span></Link>

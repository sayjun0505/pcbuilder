...
export default function Record(propss) {
    ...
    return (
        <div className="bg-white hover:cursor-pointer border-2 border-white hover:border-gray-500 border-white-500 p-2  flex w-full flex-col md:flex-row" onClick={() => detail(propss.datainfo.id)}>

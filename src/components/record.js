...
export default function Record(propss) {
    ...
    return (
        <div className="hover:cursor-pointer hover:border-2 hover:border-gray-500 border-white-500 p-2  flex w-full flex-row justify-between" onClick={() => detail(propss.datainfo.id)}>
            <div className="w-3/4 flex flex-row items-center gap-4 flex-start">
                <div className="flex flex-col justify-center">
                    <img src={propss.datainfo.img} alt="AMD Ryzen 7 7800X3D 4.2 GHz 8-Core Processor" className="w-40 h-32" />
                ...
                <div className="h-full py-4 flex w-full flex-col justify-between">
                    <a href="https://pc-builder.io/cpu/amd-ryzen-7-7800x3d-p52516" className=" font-black text-bold text-2xl ">{propss.datainfo.title}</a>
